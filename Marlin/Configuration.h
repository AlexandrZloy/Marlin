...
#define STRING_CONFIG_H_AUTHOR "(AlexandrZloy, 62b9d7d)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-4x2"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "e0eebf2c-12dc-4117-85b2-33b37e45e221"
...
#define PIDTEMP
#define BANG_MAX 205     // Limits current to nozzle while in bang-bang mode; 255=full current
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // XCR3D HEX V6 hotend + HT-NTC100K termistor (TEMP_SENSOR 11) autotuned on 235C (PID_MAX 205)
  #define DEFAULT_Kp 6.53
  #define DEFAULT_Ki 0.31
  #define DEFAULT_Kd 34.59
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // MK2a alu heatbed with insulation mat
  #define DEFAULT_bedKp 123.27
  #define DEFAULT_bedKi 21.70
  #define DEFAULT_bedKd 466.78
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 830 }
